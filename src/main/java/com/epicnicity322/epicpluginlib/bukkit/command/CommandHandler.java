...
public final class CommandHandler implements CommandExecutor, TabCompleter
{
    ...
    CommandHandler(@NotNull Collection<? extends Command> subCommands, @Nullable CommandRunnable onDescription, @Nullable CommandRunnable onUnknownCommand)
    {
     ...
     */
    private @Nullable Command findCommand(@NotNull String arg)
    {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull org.bukkit.command.Command command, @NotNull String label, @NotNull String @NotNull [] args)
    {
        ...
        if (args.length == 1) {
            list = new ArrayList<>(subCommands.size());
        ...
        if (sortCompletions && list != null) Collections.sort(list);
        return list;
    }
}
